	...
	app.service("dbDataGetSvc",
					function($http, serverURL) {
						...
						self.getPatientPhoto=function(){
							var e5 = "P100001";
							var promise1=$http.get("http://"+serverURL+"/NIMHANSproject/Services/encounterAction/image/"+e5);
							var promise2=promise1.then(function(response){
								return response.data;
							});
							return promise2;
						...
						self.getEncounterScribbleFromIncident = function(eid) {
							var e9 = eid;
							var promise1 = $http.get("http://"+serverURL+"/NIMHANSproject/Services/encounterAction/getScribbleFrmIncident/"+e9);
							var promise2 = promise1.then(function(response) {
							return response.data;
							});
							return promise2;
