...
<head>
  ...
  <link rel="stylesheet" href="bootstrap/test1.css">
	...
	<script src="DoctorList_NG.js"></script>
...
<div class="container-fluid">
		...
		<div class="col-md-10 col-sm-10"  ng-controller="AllDoctorListCtrl as ctrl">          
		  <div class="jumbotron" style="background-color:white; min-height:594px;">
          	<div>
				<table class = "table table-striped">
					...
					<td>
						<a href="#" ng-click="invokeFun(x.did)">
						{{ x.did }}
						</a>
					</td>
					<td>
