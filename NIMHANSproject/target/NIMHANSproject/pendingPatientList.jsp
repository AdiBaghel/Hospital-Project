...
%>
<html ng-app="pendingPatientList">
<head>
    <meta charset="UTF-8">
   
    <title>Pending Patient List</title>
  ...
  <link rel="stylesheet" href="bootstrap/test1.css">
	...
	<script src="pendingPatientList_NG.js"></script>
...
<div class="container-fluid">
       ...
       <!---sidebar-->
		...
		<div class="col-md-10 col-sm-10" ng-controller="pendingPatientListCtrl">    
		  ...
		  <div class="jumbotron" style="background-color:white; min-height:594px;">
			...
			<div>
				<table class = "table table-striped">
					...
					<tr ng-repeat="y in pendingPatientInfo track by $index">
					<td><a ng-href="incidentDetails.jsp?pid={{y.pid}}"> <!-- ng-click="getTraumaForm(y.pid)" -->{{ $index +1 }}</a></td>
					<td><a ng-href="incidentDetails.jsp?pid={{y.pid}}">{{ y.pid }}</a></td>
					<td><a ng-href="incidentDetails.jsp?pid={{y.pid}}">{{ y.pname }}</a></td>
					<td><a ng-href="incidentDetails.jsp?pid={{y.pid}}">{{ y.paddress }}</a></td>
					</tr>
				</table>
			</div>
