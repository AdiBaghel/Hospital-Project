...
<div class="container-fluid">
       ...
       <!---sidebar-->
		...
		<div class="col-md-10 col-sm-10"  ng-controller="SearchCtrl as ctrl">          
		  <div class="jumbotron" style="background-color:white; min-height:594px;">
            <form class="form-horizontal">
			
				<div class="form-group">
                  <label class="control-label col-sm-4" style="text-align: left">Search patient by id:</label>
			  
                    <div class="col-sm-5">
                      <input type="text" ng-model="pid" class="form-control" id="search_p_by_id" placeholder="Enter patient id"></input>
                    </div>
                </div>
				...
				<div class="form-group">
                    <div class="col-sm-offset-4 col-sm-3">
                        <button ng-click="ctrl.searchP(pid)" class="btn btn-primary ">Search</button>
                    </div>
                </div>
			</form>
			<br>
...
<div class="footer navbar-fixed-bottom" style="background-color: #455a64">
    <p>Trauma Department, NIMHANS, Bangalore-560029, India</p>   
