       ...
       <!---sidebar-->
		...
		<div class="col-md-10 col-sm-10" >          
		  <div class="jumbotron" style="min-height:594px;">
			<h4><strong><a href = "searchPatient.jsp">View Visit</a></strong></h4>
			<br>
			<h4><strong><a href = "pendingPatientList.jsp">Create New Visit</a></strong></h4>
			<br>
			<h4><strong><a href = "createPatient.jsp">Create Patient</a></strong></h4>
			<br>
			<h4><strong><a href = "PatientList.jsp">View Patient Details</a></strong></h4>
		  </div>
		</div>
